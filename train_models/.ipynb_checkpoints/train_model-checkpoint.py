...
if __name__ == '__main__':
    ...
    parser.add_argument("--target_shape", type=str, default="224x224",  help="target shape to resize the input images to")
    ...
    target_shape = ( int(it) for it in args.target_shape.split("x") )
    ...
    # Train the model
    train_generator, validation_generator, n_data = load_data(batch_size, mixup, vFlip, rotation, target_shape=target_shape)
